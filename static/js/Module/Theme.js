...
export class Theme
{
    ...
    static loadingHtml(asFragment = false, classes = '')
    {
        ...
        let html = '<span class="' + classes + 'loading"><img src="/img/loading.gif" alt="' + messages.loading + '"></span>';
    ...
    static startLoading(element, captcha = false)
    {
        ...
        if (!captcha) {
            template.innerHTML = '<span class="formloading"><img src="/img/loading.gif" alt="' + messages.loading + '"></span>';
        } else {
            template.innerHTML = '<span class="formloading"><p>' + window.messages.captchaRunning + '</p><img src="/img/loading.gif" alt="' + messages.loading + '"></span>';
        }
