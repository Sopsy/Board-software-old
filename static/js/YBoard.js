...
export class Board
{
    static getEvents()
    {
        return {
            ...
            checkAccess: {
                event: 'submit',
                fn: Board.checkAccess
            },
            timeQuickLink: {
                fn: Board.timeQuickLink
            },
            showWhois: {
                fn: Board.showWhois
            },
    ...
    static submitForm(event)
    {
        ...
        if (!event.captchaRendered && !Board.renderCaptcha(event)) {
            return;
        }
    ...
    static initElement(parent = document)
    {
        ...
        for (let refLink of parent.querySelectorAll('.ref')) {
            Board.addReflinkEventListener(refLink);
        }
    }
