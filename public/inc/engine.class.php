        ...
        if (empty($_COOKIE['key']) || !hash_equals($cookieKey, $_COOKIE['key'])) {
            ...
            if ($isProxy) {
                ...
                <head>
                    ...
                    <link rel="stylesheet" href="<?= $this->cfg->staticUrl ?>/css/1.0/board.css">
                ...
                <div class="front">
                <div id="title">
                    <img src="/img/logo/logo.svg" alt="Board" width="175">
                    <h1>Beep boop?</h1>
                </div>
                ...
                <form class="accesscheck" name="accesscheck" action="/scripts/ajax/checkaccess.php" method="post" data-e="checkAccess">
                    <input type="submit" class="linkbutton" value="Continue / Jatka" />
                </form>
                <p class="protectedbyrecaptcha"><?= $this->getCaptchaText() ?></p>
                <p>Having issues? You can contact us at info@example.com.</p>
                </div>
