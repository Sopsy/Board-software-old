...
$cfg->siteName = 'Board';
$cfg->siteMotto = 'Software';
$cfg->siteLogoUrl = '/img/logo/vauhis.png';
$cfg->siteUrl = 'http://localhost:9002';
$cfg->noreplyEmail = 'noreply@example.com';
$cfg->replyToEmail = 'info@example.com';
